...
type URLShortenerClient interface {
	Create(ctx context.Context, in *OriginalURL, opts ...grpc.CallOption) (*ShortCode, error)
	Get(ctx context.Context, in *ShortCode, opts ...grpc.CallOption) (*OriginalURL, error)
}
...
func (c *uRLShortenerClient) Create(ctx context.Context, in *OriginalURL, opts ...grpc.CallOption) (*ShortCode, error) {
	out := new(ShortCode)
...
func (c *uRLShortenerClient) Get(ctx context.Context, in *ShortCode, opts ...grpc.CallOption) (*OriginalURL, error) {
	out := new(OriginalURL)
...
type URLShortenerServer interface {
	Create(context.Context, *OriginalURL) (*ShortCode, error)
	Get(context.Context, *ShortCode) (*OriginalURL, error)
...
func (UnimplementedURLShortenerServer) Create(context.Context, *OriginalURL) (*ShortCode, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedURLShortenerServer) Get(context.Context, *ShortCode) (*OriginalURL, error) {
...
func _URLShortener_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLShortenerServer).Create(ctx, req.(*OriginalURL))
	}
...
func _URLShortener_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLShortenerServer).Get(ctx, req.(*ShortCode))
	}
	return interceptor(ctx, in, info, handler)
}
